                                        ...
                                        gpointer         user_data)
{
  GtkWidget *about;
  const gchar *authors[] = {
		  "Rog�rio Villela de Lima Bastos \"Epic\" (rogbas@gmail.com)", NULL };
  about = gnome_about_new ("Epilog", VERSION, "Copyright 2002 Rog�rio Bastos.", (const gchar **) authors, "Multi-file logging program with key word coloring", NULL);
